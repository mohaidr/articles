...
- الل **Concurrency:** التبديل السريع بين المهام (كالأم التي تهتم بشؤون عائلتها فتغسل و تطبخ و تجلي و ترعى الأطفال و تنتقل بين أعمالها و كأنها تنجزها جميعا معا و لكنها في الحقيقة تتنقل بينهم) قد يبدو .
...
| ال **Threads المستخدمة** | قد يكون thread واحد (مع async) | cores/threads متعددة |
